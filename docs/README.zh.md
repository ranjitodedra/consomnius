...
consomnius 是一款支持多个大语言模型（LLM）服务商的桌面客户端，兼容 Windows、Mac 和 Linux 系统。
...
❤️ 喜欢 consomnius? 点亮小星星 🌟 或 [赞助开发者](sponsor.md)! ❤️
...
我们欢迎对 consomnius 的贡献！您可以通过以下方式贡献：
...
我们正在启动 consomnius 开发者共创计划，旨在为开源生态系统构建一个健康、正向反馈的循环。我们相信，优秀的软件是通过协作构建的，每一个合并的拉取请求都为项目注入新的生命力。

我们诚挚地邀请您加入我们的贡献者队伍，与我们一起塑造 consomnius 的未来。
...
在任何跟踪周期内（例如，首个周期的 7月1日 至 9月30日），任何为 consomnius 在 GitHub 上的开源项目贡献超过 **30 个有意义提交** 的开发者都有资格获得以下福利：
...
活跃的社区是任何可持续开源项目背后的推动力。随着 consomnius 的发展，我们的奖励计划也将随之发展。我们致力于持续将我们的福利与行业内最优秀的工具和资源保持一致。这确保我们的核心贡献者获得有意义的支持，创造一个开发者、社区和项目共同成长的正向循环。
...
在社区版的基础上，我们自豪地推出 **consomnius 企业版**——一个为现代团队和企业设计的私有部署 AI 生产力与管理平台。
...
**🔗 [consomnius 企业版](https://www.cherry-ai.com/enterprise)**
...
我们相信企业版将成为您团队的 AI 生产力引擎。如果您对 consomnius 企业版感兴趣，希望了解更多信息、请求报价或安排演示，请联系我们。
